...
+(NSString *)AES256Encrypt:(NSString *) content
{
    ...
    NSData * ecdata =[data AES256EncryptWithKey];
    NSString * string = [Base64 base64EncodedStringFrom:ecdata];
    return string;
}
+(NSString *)AES256Decrypt:(NSString *)content
{
    NSData * data = [Base64 dataWithBase64EncodedString:content];
